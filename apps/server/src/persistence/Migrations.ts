...
import Migration0019 from "./Migrations/019_ProjectionWorkspaces.ts";
import Migration0020 from "./Migrations/020_ProjectionWorkItems.ts";
...
export const migrationEntries = [
  ...
  [19, "ProjectionWorkspaces", Migration0019],
  [20, "ProjectionWorkItems", Migration0020],
] as const;
